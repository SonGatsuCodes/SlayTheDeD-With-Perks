...
public class CardEditor : Editor
{
    ...
    {
        if(teste==null)
        {teste=new Texture2D(1,1);teste.SetPixel(0,0,Color.black);}
        ...
        GUILayout.Label("Art               Background             CostArt",
         GUILayout.Height(30), GUILayout.Width(260));
        GUI.DrawTexture(GUILayoutUtility.GetLastRect(), teste);
